# busungtk-landing - B2B 랜딩페이지

부성티케이 B2B 마케팅용 랜딩페이지 (아임웹용)
...
## 프로젝트 구조
```
digital-partnership.html   # 디지털 파트너십 랜딩
process-detail.html        # 서비스 프로세스
quality.html               # 품질 관리
solutions.html             # 솔루션 소개
portfolio.html             # 고객 포트폴리오
```

## 주요 기능
- 회사 브랜드 스토리텔링 (히어로 + 통계)
- 5단계 서비스 프로세스 타임라인
- 고객 사례 및 포트폴리오 (삼성전자, CJ프레시웨이 등)
- FAQ 아코디언 및 CTA

## 배포
- **Vercel**: https://busungtk-landing.vercel.app
